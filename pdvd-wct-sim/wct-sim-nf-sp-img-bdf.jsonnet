...
local sp = sp_maker(params, tools, { sparse: false, use_roi_debug_mode: true, use_multi_plane_protection: true, mp_tick_resolution: 4, });
...
local img = import "/nfs/data/1/yujin/img_BlobDepoFill/pdvd-wct-sim/img.jsonnet";
local img_maker = img();
