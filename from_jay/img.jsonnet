...
function() {
    ...
    // utilities
    sink(anode, aname) :: img.dump(anode, aname, drift_speed=params.lar.drift_speed),
    blob_depo_fill(anode, name, drift_speed=params.lar.drift_speed) :: g.pnode({
        type: "BlobDepoFill",
